# prepare_ml snapshots
    ...
    Output
      ...
      # ... with 205 more rows, and 7 more variables: BMI_advs <dbl>, BPDIA <dbl>,
      #   BPSYS <dbl>, HR <dbl>, WEIGHT <dbl>, cardiac_arrhythmias <int>,
      ...
      # ... with 64 more rows, and 7 more variables: BMI_advs <dbl>, BPDIA <dbl>,
      #   BPSYS <dbl>, HR <dbl>, WEIGHT <dbl>, cardiac_arrhythmias <int>,
      #   coronary_artery_disorders <int>
      ...
      # A tibble: 215 x 13
       ...
       4 10022 PLC   60_to_under_75 M     WHITE    64     24      54   101  80     73.4
       5 10026 PLC   at_least_75    F     WHITE    82     28.9    68   102  68.6   95.6
       6 10030 PLC   60_to_under_75 F     WHITE    72     26.6    78    95  71     71.9
       7 10031 PLC   under_60       F     WHITE    48     28      63   116  78     84.3
       8 10032 PLC   at_least_75    M     WHITE    77     31.9    74    92  56     99.5
       9 10037 PLC   60_to_under_75 M     WHITE    65     29.5    76   136  50     88.9
      10 10038 PLC   under_60       M     WHITE    59     31.4    82   125  76     91  
      # ... with 205 more rows, and 2 more variables:
      #   coronary_artery_disorders <int>, .out <fct>
      ...
      # A tibble: 74 x 13
       ...
       7 10041 PLC   60_to_under_75 F     WHITE    63     25.7    74   139    82   90.4
      ...
      # ... with 64 more rows, and 2 more variables: coronary_artery_disorders <int>,
      #   .out <fct>
      ...
      # A tibble: 17 x 8
       ...
       1 .out                      .out     user_o~ .out     <NA>  <NA>    <NA>  <NA> 
       2 .trt                      .trt     SL      Actual ~ adsl  adsl    <NA>  <NA> 
       3 AGE                       AGE      SL      Age      adsl  adsl    <NA>  <NA> 
       4 AGEGR01                   AGEGR01  SL      Age Gro~ adsl  adsl    <NA>  <NA> 
       5 SEX                       SEX      SL      Sex      adsl  adsl    <NA>  <NA> 
       6 RACE                      RACE     SL      Race     adsl  adsl    <NA>  <NA> 
       7 BMI_adsl                  BMI_adsl SL      Body Ma~ adsl  adsl    <NA>  <NA> 
       8 LAB1                      LAB1     LB      Laborat~ bds   adlb    unit1 <NA> 
       9 LAB2                      LAB2     LB      Laborat~ bds   adlb    unit2 <NA> 
      10 LAB3                      LAB3     LB      Laborat~ bds   adlb    unit3 <NA> 
      11 BMI_advs                  BMI_advs VS      Body Ma~ bds   advs    kg/m2 <NA> 
      12 BPDIA                     BPDIA    VS      Diastol~ bds   advs    mmHg  <NA> 
      13 BPSYS                     BPSYS    VS      Systoli~ bds   advs    mmHg  <NA> 
      14 HR                        HR       VS      Heart R~ bds   advs    beat~ <NA> 
      15 WEIGHT                    WEIGHT   VS      Weight   bds   advs    kg    <NA> 
      16 cardiac_arrhythmias       cardiac~ MH      Cardiac~ occds admh    <NA>  <NA> 
      17 coronary_artery_disorders coronar~ MH      Coronar~ occds admh    <NA>  <NA> 
      ...
      K-nearest neighbor imputation for .trt, AGEGR01, SEX, AGE, BMI_adsl, ... [trained]
      Removing rows with NA values in recipes::all_predictors()
      Sparse, unbalanced variable filter removed cardiac_arrhythmias [trained]
      Correlation filter removed BMI_adsl [trained]
...
---
    ...
    Output
      ...
      # ... with 206 more rows, and 7 more variables: BMI_advs <dbl>, BPDIA <dbl>,
      #   BPSYS <dbl>, HR <dbl>, WEIGHT <dbl>, cardiac_arrhythmias <int>,
      #   coronary_artery_disorders <int>
      ...
      # ... with 63 more rows, and 7 more variables: BMI_advs <dbl>, BPDIA <dbl>,
      #   BPSYS <dbl>, HR <dbl>, WEIGHT <dbl>, cardiac_arrhythmias <int>,
      #   coronary_artery_disorders <int>
      ...
      # A tibble: 216 x 13
       ...
       9 10022 PLC   60_to_under_75 M     WHITE    64     24      54   101    80   73.4
      10 10024 PLC   at_least_75    M     WHITE    83     24.4    65   133    60   64.2
      # ... with 206 more rows, and 2 more variables:
      #   coronary_artery_disorders <int>, .out <dbl>
      
      $data_prep$test
      # A tibble: 73 x 13
           .id .trt  AGEGR01        SEX   RACE    AGE BMI_advs BPDIA BPSYS    HR WEIGHT
         <dbl> <fct> <fct>          <fct> <fct> <dbl>    <dbl> <dbl> <dbl> <dbl>  <dbl>
       1 10003 TRT   60_to_under_75 F     WHITE    62     17.7    59   105    86   51.9
       ...
       6 10014 PLC   60_to_under_75 M     WHITE    64     23.5    83   126    84   75.4
       7 10019 TRT   60_to_under_75 M     WHITE    62     22.1    56   101    56   57.8
      ...
      # ... with 63 more rows, and 2 more variables: coronary_artery_disorders <int>,
      #   .out <dbl>
...
---
    ...
    Output
      ...
      # ... with 206 more rows, and 8 more variables: LAB3 <dbl>, BMI_advs <dbl>,
      #   BPDIA <dbl>, BPSYS <dbl>, HR <dbl>, WEIGHT <dbl>,
      #   cardiac_arrhythmias <int>, coronary_artery_disorders <int>
      ...
      # ... with 63 more rows, and 8 more variables: LAB3 <dbl>, BMI_advs <dbl>,
      #   BPDIA <dbl>, BPSYS <dbl>, HR <dbl>, WEIGHT <dbl>,
      #   cardiac_arrhythmias <int>, coronary_artery_disorders <int>
      ...
      # A tibble: 216 x 14
       ...
       4 10028 PLC   60_to_under_75 M     WHITE    66     34.5  75     134  67    112. 
       5 10036 PLC   60_to_under_75 F     WHITE    60     26    69.6   128  56     62.6
       6 10039 PLC   60_to_under_75 F     WHITE    71     23.8  80      96  84     78.3
       7 10043 PLC   60_to_under_75 M     WHITE    70     23.2  85     134  48     64.9
       8 10048 PLC   at_least_75    F     WHITE    76     24.8  66     109  63     68  
       9 10067 PLC   60_to_under_75 F     WHITE    60     25    69     135  76     67  
      10 10071 PLC   under_60       F     WHITE    53     22.7  61     124  76     65.4
      # ... with 206 more rows, and 3 more variables:
      #   coronary_artery_disorders <int>, .time <dbl>, .status <dbl>
      ...
      # A tibble: 73 x 14
       ...
       6 10022 PLC   60_to_under_75 M     WHITE    64     24      54   101    80   73.4
       7 10025 TRT   under_60       F     WHITE    46     30.8    73   117    70   85.4
       8 10027 TRT   under_60       M     WHITE    53     24.1    80   152    69   50.2
       9 10030 PLC   60_to_under_75 F     WHITE    72     26.6    78    95    71   71.9
      10 10031 PLC   under_60       F     WHITE    48     28      63   116    78   84.3
      # ... with 63 more rows, and 3 more variables: coronary_artery_disorders <int>,
      #   .time <dbl>, .status <dbl>
      ...
      # A tibble: 18 x 8
         param                     column   source  label    type  spec_id unit  logtr
         <chr>                     <chr>    <chr>   <chr>    <chr> <chr>   <chr> <chr>
       1 .time                     .time    user_o~ .time    <NA>  <NA>    <NA>  <NA> 
       2 .status                   .status  user_o~ .status  <NA>  <NA>    <NA>  <NA> 
       3 .trt                      .trt     SL      Actual ~ adsl  adsl    <NA>  <NA> 
       4 AGE                       AGE      SL      Age      adsl  adsl    <NA>  <NA> 
       5 AGEGR01                   AGEGR01  SL      Age Gro~ adsl  adsl    <NA>  <NA> 
       6 SEX                       SEX      SL      Sex      adsl  adsl    <NA>  <NA> 
       7 RACE                      RACE     SL      Race     adsl  adsl    <NA>  <NA> 
       8 BMI_adsl                  BMI_adsl SL      Body Ma~ adsl  adsl    <NA>  <NA> 
       9 LAB1                      LAB1     LB      Laborat~ bds   adlb    unit1 <NA> 
      10 LAB2                      LAB2     LB      Laborat~ bds   adlb    unit2 <NA> 
      11 LAB3                      LAB3     LB      Laborat~ bds   adlb    unit3 <NA> 
      12 BMI_advs                  BMI_advs VS      Body Ma~ bds   advs    kg/m2 <NA> 
      13 BPDIA                     BPDIA    VS      Diastol~ bds   advs    mmHg  <NA> 
      14 BPSYS                     BPSYS    VS      Systoli~ bds   advs    mmHg  <NA> 
      15 HR                        HR       VS      Heart R~ bds   advs    beat~ <NA> 
      16 WEIGHT                    WEIGHT   VS      Weight   bds   advs    kg    <NA> 
      17 cardiac_arrhythmias       cardiac~ MH      Cardiac~ occds admh    <NA>  <NA> 
      18 coronary_artery_disorders coronar~ MH      Coronar~ occds admh    <NA>  <NA> 
